<template>
  <div class="bg-white">
      ...
      >
        ...
        >
          <div class="flex items-center justify-between">
            <a href="#" class="-m-1.5 p-1.5">
              <span class="sr-only">Your Company</span>
              <img class="h-8 w-auto" src="~/assets/img/logoatred.png" alt="" />
            </a>
            <button
              type="button"
    ...
    <div class="relative">
          ...
          <div class="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
              <div class="hidden sm:mb-10 sm:flex">
                ...
                >
                  Découvrez notre cahier des charges 2023
                  <a
                    href="#"
              ...
              >
                Sous-traitez la gestion de vos déchets inertes
              </h1>
      ...
      <div
        class="bg-gray-50 lg:absolute lg:inset-y-0 mt-32 lg:right-0 lg:w-1/2"
      >
        <img
...
const navigation = [
  { name: "Déchets inertes", href: "#" },
  { name: "Matériaux recyclés", href: "#" },
